...
const inputCls =
  "w-full px-4 py-3 rounded-xl border border-[#1F1B16]/12 dark:border-[#F7F3EC]/12 bg-[#F7F3EC] dark:bg-[#0E0C0A] text-sm text-[#1F1B16] dark:text-[#F7F3EC] placeholder:text-[#1F1B16]/30 dark:placeholder:text-[#F7F3EC]/30 focus:outline-none focus:border-accent-teal focus:ring-2 focus:ring-accent-teal/15 transition-all duration-200";
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                              <Field label="City *">
                                <input type="text" required value={shippingForm.city} onChange={sf("city")} className={inputCls} placeholder="Mumbai" />
                              </Field>
                              <Field label="State *">
                                <input type="text" required value={shippingForm.state} onChange={sf("state")} className={inputCls} placeholder="Maharashtra" />
                              </Field>
                              <Field label="PIN Code *">
                                <input type="text" required value={shippingForm.postalCode} onChange={sf("postalCode")} className={inputCls} placeholder="400001" />
                              </Field>
                            </div>
                          </div>
                          <button
                            type="submit"
                            className="w-full flex items-center justify-center gap-2 bg-[#1F1B16] dark:bg-[#F7F3EC] text-[#F7F3EC] dark:text-[#1F1B16] hover:bg-accent-teal dark:hover:bg-accent-teal hover:text-white dark:hover:text-white text-xs font-bold tracking-[0.1em] uppercase py-4 rounded-xl transition-all duration-200"
                          >
