...
export default function Navbar({ transparent = false }: NavbarProps) {
  ...
  return (
    <header className="fixed top-3 left-0 w-full z-50 px-4 sm:px-8 md:px-12 flex items-center justify-between pointer-events-none">
      ...
      {/* 1. BRAND LOGO (Positioned on the Left) */}
      <a
        href="/"
      ...
      >
        ...
        <img
          ...
          className="h-10 sm:h-12 md:h-16 lg:h-20 w-auto object-contain drop-shadow-md"
        />
      </a>

      {/* 2. FLOATING NAV PILL (Perfectly Centered horizontally using absolute positioning on desktop) */}
      <div className="lg:absolute lg:left-1/2 lg:-translate-x-1/2 pointer-events-auto">
        <nav
        ...
        >
          ...
          {searchActive ? (
            <motion.form
              ...
              className="flex items-center gap-2 px-3 py-1 bg-white/90 dark:bg-charcoal/90 border border-charcoal/15 dark:border-cream/20 rounded-full shadow-inner"
            >
          ...
          {/* Action Icons (Theme, Search, User, Cart, Mobile Menu) */}
